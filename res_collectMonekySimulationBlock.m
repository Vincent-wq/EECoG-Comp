...
load([P '\res\MonkeySim_resROC_block_2019_01_22'])
...
title('Monkey EEG-ECoG ESI Methods Performance for Block Source ($spAUC=0.1$)','interpreter','latex')
xticks(1:1:8)
...
%print(['fig\MonkeySimESI_block_' num2str(P) '_pAUC.tiff'],'-dtiff','-r300');
