...
compartmentFolder = fullfile(datafolder, 'CompartmentsCorrected');
...
%% save again all the compartments
save(fullfile(compartmentFolder,'Cortex_red_10007'), 'Cortex_red');
save(fullfile(compartmentFolder,'Silicone'),           'Silicone');
save(fullfile(compartmentFolder,'Inskull'),             'Inskull');
save(fullfile(compartmentFolder,'Silicone'),           'Silicone');
save(fullfile(compartmentFolder,'Outskull'),           'Outskull');
save(fullfile(compartmentFolder,'Scalp'),                 'Scalp');
%% head modeling
% EEG head model
